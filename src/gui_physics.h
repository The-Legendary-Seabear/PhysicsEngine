...
*
*   Copyright (c) 2022 Kohn. All Rights Reserved.
*
...
void GuiPhysics(GuiPhysicsState *state)
{
    ...
    if (state->PhysicsPanelActive)
    {
        ...
        GuiSlider((Rectangle){ state->anchor02.x + 80, state->anchor02.y + 568, 184, 16 }, "GRAVITY", GUI_TEXT(state->GravityValue), & state->GravityValue, 0, 100);
